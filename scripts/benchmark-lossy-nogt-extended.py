            ...
            for strategy in strategies:
                ...
                for factor in factors[strategy]:
                    ...
                    if not is_entry(benchmark_file, entry_data):
                        ...
                        rec_compressed, cr, xRT, elapsed_time, rmse = \
                            benchmark_compression(rec_to_compress, compressor, zarr_path, 
                                                  filters=filters, time_range=time_range_rmse, 
                                                  **job_kwargs)
                        print(f"Compression {rec_name}: cspeed xrt - {xRT} - CR: {cr} - rmse: {rmse}\n")


                        new_data = {"dataset": dset_name, "session": session , "probe": probe_name, "strategy": strategy, 
                                    "factor": factor, "CR": cr, "cspeed_xrt": xRT, 
                        ...
                        print(f"\nSummary {rec_name}:\n")
                        print(f"Compression: cspeed xrt - {xRT} - CR: {cr} - rmse: {rmse}\n")
