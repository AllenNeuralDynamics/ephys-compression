...
# define job kwargs
n_jobs = None
job_kwargs = {'n_jobs': n_jobs if n_jobs is not None else os.cpu_count(), "verbose": False, "progress_bar": False}
...
preprocessing_options = {
    ...
    'bandpass_300-3000': dict(preprocess_fun=spre.bandpass_filter,
                              preprocess_params={"freq_min": 300, 'freq_max': 3000}),
    'bandpass_500-3000': dict(preprocess_fun=spre.bandpass_filter,
                              preprocess_params={"freq_min": 500, 'freq_max': 3000}),
    'bandpass_300-6000': dict(preprocess_fun=spre.bandpass_filter,
                              preprocess_params={"freq_min": 300, 'freq_max': 6000}),
    'bandpass_500-6000': dict(preprocess_fun=spre.bandpass_filter,
            ...
            for session in sessions:
                ...
                for level_name, level in level_compressor.items():
                    for shuffle_name, shuffle in shuffles[compressor_type].items():
                        for preprocessing_name, preprocessing_option in preprocessing_options.items():
                            entry_data = {"session": session, "dataset": dset_name,
                                          ...
                                          "channel_chunk_size": channel_chunk_size, "preprocessing": preprocessing_name}
                            ...
                            if not is_entry(benchmark_file, entry_data):
                                ...
                                data = {"session": session, "dataset": dset_name,
                                        ...
                                        "level": level_name, "shuffle": shuffle_name,
